...
typedef struct sbufdesc
{
	...
	int 	    lruNext;		// CS460: for LRU list next
	int 	 	lruPrev; 		// CS460: for LRU list prev
} BufferDesc;
 ...
 *  CS460: special mark
 */
#define LRUNEXT_END_OF_LIST 	(-1)
#define LRUPREV_HEAD_OF_LIST	(-1)
...
extern void ShowBufferDesc(volatile BufferDesc *buf, int mark);
extern void ShowAllBufferDesc(int chosen);
